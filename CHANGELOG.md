...
## [2.18.0](https://github.com/AKJUS/bash-completion/compare/2.17.0...2.18.0) (2026-07-01)


### Features

* **_comp__init:** source system startup files earlier ([b09700d](https://github.com/AKJUS/bash-completion/commit/b09700dda29b56fb89812e1215956a631cc7c848))
...
* **_comp_compgen_filedir:** support "filedir -X" ([ce28419](https://github.com/AKJUS/bash-completion/commit/ce2841911c7a3f5a056b6a310038f0df17a8da42))
...
* **_comp_compgen_sysv_services:** factorize SysV service generation ([c4c8c4b](https://github.com/AKJUS/bash-completion/commit/c4c8c4b54040d4acc2688ed8fc040330d964fe12))
...
* **apt-*:** update known options up to apt 3.2.0 ([c421d50](https://github.com/AKJUS/bash-completion/commit/c421d508b6d922ee43364fd9e0d9bc3bddb5f56c))
* **apt-cache:** update known options up to apt 3.2.0 ([0ab85c5](https://github.com/AKJUS/bash-completion/commit/0ab85c5ff2c39300acfce0afde2e65b707e314b4))
* **apt-get:** update known options up to apt 3.2.0 ([6a18e0c](https://github.com/AKJUS/bash-completion/commit/6a18e0c0cf11c9be16616bc817f4613cb9ba95b0))
* **apt-mark:** update known options up to apt 3.2.0 ([644a026](https://github.com/AKJUS/bash-completion/commit/644a0268c117c98a6915dfd23548a3a8b8def6db))
...
* **codex:** 3rd party fallback completion loader ([0f425bd](https://github.com/AKJUS/bash-completion/commit/0f425bd37c2982b70f6c2ce865eeae0af05a715d))
* **copilot:** 3rd party fallback completion loader ([744602a](https://github.com/AKJUS/bash-completion/commit/744602ac64dc24586e2492813751cc38a0aef2d7))
...
* **curlie:** alias to curl ([dd8f6e0](https://github.com/AKJUS/bash-completion/commit/dd8f6e0bf8379403f434f732d568bc15c16b9809))
...
* **doas:** add new completion ([f047b70](https://github.com/AKJUS/bash-completion/commit/f047b70f140d2ca1186539f5e2bf86a0d797aa19))
* **doas:** generate completions as if we're root ([a705713](https://github.com/AKJUS/bash-completion/commit/a705713f8a5785d8e0a373224138d24977bc5865))
* **doas:** new completion ([ad5ec9a](https://github.com/AKJUS/bash-completion/commit/ad5ec9ad2ed213e0f577809e8588cecf388103ae))
* **encore:** 3rd party fallback completion loader ([1e54d02](https://github.com/AKJUS/bash-completion/commit/1e54d027efbc47c6a7cd30b9937588d696be547f))
* **etcdctl,etcdutl:** 3rd party fallback completion loaders ([39f8ddf](https://github.com/AKJUS/bash-completion/commit/39f8ddf18726c1f14d0fabb35538dbf9c38a8884))
...
* **helium:** alias to chromium-browser ([8600af0](https://github.com/AKJUS/bash-completion/commit/8600af029c75fee141af9af6bc301d8c31e45551))
* **inotifywait2:** generate exclude filenames prefixed by `@` ([c1e2f1b](https://github.com/AKJUS/bash-completion/commit/c1e2f1b47af4f843c0dd41e6ed066d67b99b76f3))
* **inotifywait:** generate exclude filenames prefixed by @ ([0a2c165](https://github.com/AKJUS/bash-completion/commit/0a2c165378a74fa918ace3dc0779e7ca13212ae5))
...
* **ogg123:** associate opus extension ([7d3ea33](https://github.com/AKJUS/bash-completion/commit/7d3ea3376865470207dab25067209394c002b32e))
...
* support the "startup{,-core}" directory ([d6169af](https://github.com/AKJUS/bash-completion/commit/d6169afc53799d79aee437e14be109698215a0da))
...
* **ty:** add 3rd party fallback completion loader ([9f115fe](https://github.com/AKJUS/bash-completion/commit/9f115fe1785c28aaa3265e50268cac343f24bdb7))
* **ty:** add 3rd party fallback completion loader ([57a2b31](https://github.com/AKJUS/bash-completion/commit/57a2b31e866bd5b01e85fb14844e2a9fe0c378ec))
...
* **xrdb:** misc improvements ([#1669](https://github.com/AKJUS/bash-completion/issues/1669)) ([461f90c](https://github.com/AKJUS/bash-completion/commit/461f90c6a75f2e09ab4f4262ff365c3ad0fac9dd))
...
* **_comp_compgen_services:** fix no completions without sysvdir ([a2e2659](https://github.com/AKJUS/bash-completion/commit/a2e26592218e1bebb55f18ab3e3b58f2fe7ec151))
* **_comp_compgen_services:** skip service status marks ([1ac9169](https://github.com/AKJUS/bash-completion/commit/1ac9169593ff26985f31ba481aa889b9d64151ec))
* **_comp_compgen_sysv_services:** do not generate names in subdirs ([5557fbe](https://github.com/AKJUS/bash-completion/commit/5557fbe488c10cbc07a604cc330e86ee1de17efb))
...
* **_comp_complete_user_at_host:** care about $cur starting with "-" ([277da58](https://github.com/AKJUS/bash-completion/commit/277da58cfcfc0cca55adf7f3fff0b978636987c5))
...
* **_known_hosts:** fix spacing of an error message ([0463570](https://github.com/AKJUS/bash-completion/commit/046357094cd4c10b9deb714594c409100cfedfe3))
* **_known_hosts:** work around custom IFS ([8171929](https://github.com/AKJUS/bash-completion/commit/8171929827ede9b2ce861fec73f8572230d3c587))
...
* **_variable_assignments:** exclude invalid timezones for "TZ" ([d405a1d](https://github.com/AKJUS/bash-completion/commit/d405a1dee04786846c88f1f02ff37dbafaa0d990))
...
* **compatdir:** shadow compat files of the same name ([ff1bf72](https://github.com/AKJUS/bash-completion/commit/ff1bf722c6ecbf0d6fe491d345c08fa0c981035e))
...
* **export:** complete options not at $1 ([832822d](https://github.com/AKJUS/bash-completion/commit/832822dccbbca44d13dbbf3a4b6b63905dd74d9e))
* **export:** suffix "=" only when the candidate is unique and already complete ([313d26d](https://github.com/AKJUS/bash-completion/commit/313d26daf1e1a56359d1454f3f2e47822b9eb783))
* **export:** suffix "=" only when unique and already complete ([76f980c](https://github.com/AKJUS/bash-completion/commit/76f980c3195289af25a5941d9bcfcdeb40e42eb6))
* **export:** work around custom IFS ([2617d26](https://github.com/AKJUS/bash-completion/commit/2617d26d339724eb5052a95fb0a7ad8dd64d0f43))
...
* **inotifywait:** add `-t` in `noargopts` ([0295129](https://github.com/AKJUS/bash-completion/commit/02951294d39fd96faddc7614f5771475cf2863a1))
...
* **pkg-get:** avoid double expansions ([fb5e32c](https://github.com/AKJUS/bash-completion/commit/fb5e32ce308260c3c1131dbf971213c87f6c5303))
* **pkg-get:** do not check the command name as arguments ([a86175d](https://github.com/AKJUS/bash-completion/commit/a86175d6d49b635f5f397334d16366df45e7ef48))
* **pkg-get:** localize variable "file" properly ([c37bed1](https://github.com/AKJUS/bash-completion/commit/c37bed1f352a83bf36afc7a65088dc1c42219dae))
* **pkg-get:** work around localvar_inherit ([7881795](https://github.com/AKJUS/bash-completion/commit/7881795f562017bce000cc3d063076b01c5f6f23))
* **pkg-get:** work around nounset ([cd5c28d](https://github.com/AKJUS/bash-completion/commit/cd5c28df700cb5d4626d2fc110664741c3bf3bf3))
* **povray:** work around bash-4.3 nounset ([8f85887](https://github.com/AKJUS/bash-completion/commit/8f85887d02dc9e5739c067d3281850be562040d8))
...
* **service,{invoke,update}-rc.d:** fix regressions and refactor ([1ee269f](https://github.com/AKJUS/bash-completion/commit/1ee269f86e4cb6d048c86d6b483a46b868aba200))
...
* **tox:** move completion to fallback directory ([be397c2](https://github.com/AKJUS/bash-completion/commit/be397c2c046ac2bd37a28e29b1ce6655f9a475fa))
...
* **povray:** use glob matching instead of grep ([25f3bb5](https://github.com/AKJUS/bash-completion/commit/25f3bb52a09e76bc8f8c3f4f87bbf25bd1a2f14e))
